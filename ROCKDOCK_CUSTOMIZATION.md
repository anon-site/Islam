...
### 📥 تصدير الإعدادات
يمكنك حفظ جميع تخصيصاتك في ملف JSON:

1. افتح نافذة التخصيص
2. اضغط على زر **"📥 تصدير"** في أسفل يسار النافذة
3. سيتم تنزيل ملف باسم: `JS RockDock_YYYY-MM-DD.json`
4. احتفظ بالملف في مكان آمن

**ماذا يحتوي الملف؟**
- جميع عناصر الشريط الأيمن
- جميع عناصر الشريط الأيسر
- الروابط، الأيقونات، والأوصاف
- رقم الإصدار والتاريخ

### 📤 استيراد الإعدادات
استعد تخصيصاتك من ملف سابق:

1. افتح نافذة التخصيص
2. اضغط على زر **"📤 استيراد"**
3. اختر ملف JSON المُصدّر
4. ستظهر رسالة نجاح مع عدد العناصر
5. اضغط **"حفظ التغييرات"** لتطبيق البيانات

**فوائد التصدير/الاستيراد:**
- ✅ **نسخ احتياطي**: احفظ إعداداتك بأمان
- ✅ **مشاركة**: شارك تخصيصاتك مع الآخرين
- ✅ **نقل بين أجهزة**: انقل إعداداتك لجهاز آخر
- ✅ **تجربة إعدادات**: جرّب إعدادات مختلفة بسهولة

### 📋 مثال على تنسيق الملف
يمكنك إنشاء ملف JSON يدوياً بالتنسيق التالي:
...
✅ **ملف نموذجي متاح**: `JS RockDock_example.json`
...
### المشكلة: فشل استيراد الملف
**الحل**:
1. تأكد أن الملف بصيغة `.json`
2. افتح الملف في محرر نصوص وتحقق من صحة التنسيق
3. تأكد من وجود `rightDock` و `leftDock`
4. تحقق من عدم وجود أخطاء في JSON syntax

### المشكلة: لا يتم تنزيل ملف التصدير
**الحل**:
1. تحقق من أذونات المتصفح للتنزيل
